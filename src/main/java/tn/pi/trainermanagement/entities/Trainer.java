...
public class Trainer {
    ...
    public Trainer(long trainerId, String firstName, String lastName, String email, String phone, long age, String profession, String department, Level level, Gender gender, Status status) {
